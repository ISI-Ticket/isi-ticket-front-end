...
(function (root) {
    ...
    Protected.prototype = {
        ...
        rules: {
            ...
            zip: function (value) {
                return new RegExp(/^[1-9][0-9]{3}-[0-9]{3}$/g).test(value);
            },
        ...
        hideErrors: function (validationField, removeClass) {
            ...
            Object.keys(this.fields).forEach(function (n) {
                if ((validationField && validationField === self.fields[n].handle) || !validationField) {
                    ...
                    self.fields[n].handle.style.borderBottom = '1px solid #4BB543';
                    self.fields[n].handle.style.color = '#4BB543'
            ...
            var self = this,
                ...
                insertNodeError = function (refNode, errorObj) {
                    ...
                    if (self.settings.showErrors) {
                        ...
                        refNode.style.borderBottom = '1px solid #e33742';
                        refNode.style.color = '#e33742';
